...
interface NotificationDeniedSheetProps {
  visible: boolean;
  onOpenSettings: () => void;
  onClose: () => void;
}

export function NotificationDeniedSheet({
  visible,
  onOpenSettings,
  onClose,
}: NotificationDeniedSheetProps) {
  return (
    <BottomSheet visible={visible} onClose={onClose}>
      <Text style={styles.title}>휴대폰 기기의 앱 알림이 꺼져있어요</Text>
