...
export default function ZodiacDetailScreen() {
  ...
  const validSign = typeof sign === 'string' && sign in ZODIAC_MAP
    ? (sign as ZodiacSign)
    : null;
    ...
    <LinearGradient colors={gradients.screen} style={styles.fill}>
      ...
      <View style={[styles.backRow, { paddingTop: insets.top + 8 }]}>
        <TouchableOpacity onPress={() => router.back()} hitSlop={12} style={styles.backBtn}>
          <FontAwesome name="chevron-left" size={16} color={colors.apricotDark} />
        </TouchableOpacity>
      </View>
          ...
          <>
            ...
            <View style={styles.hero}>
              ...
              <View style={styles.circleOuter}>
                ...
                >
                  <Defs>
                    <RadialGradient id="detailCircleGlow" cx="50%" cy="50%" r="50%">
                  ...
                  <Circle cx={84} cy={84} r={84} fill="url(#detailCircleGlow)" />
                </Svg>
