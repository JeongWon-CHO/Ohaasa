...
export const ZODIAC_LIST: ZodiacInfo[] = [
  ...
  { sign: 'virgo',       emoji: '♍', ko: '처녀자리',   en: 'Virgo',       ja: 'おとめ座',   dateRange: '8/23-9/23' },
  { sign: 'libra',       emoji: '♎', ko: '천칭자리',   en: 'Libra',       ja: 'てんびん座', dateRange: '9/24-10/22' },
  { sign: 'scorpio',     emoji: '♏', ko: '전갈자리',   en: 'Scorpio',     ja: 'さそり座',   dateRange: '10/23-11/22' },
